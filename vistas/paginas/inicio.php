         ...
         <div class="row g-4 justify-content-center">
            <div class="col-lg-12">
               <div class="banner__content center">
                  ...
                  <h5 class="wow fadeInUp" data-wow-duration="2s">LA BODA DE:</h5>
                  <h1 class="wow fadeInDown" data-wow-duration="4s">Miguel y Yare</h1>
                  <h3 class="wow fadeInUp" data-wow-duration="2s">Estan invitados</h3>
               </div>
            </div>
         </div>
      </div>
